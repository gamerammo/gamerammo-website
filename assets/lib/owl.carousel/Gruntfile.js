  ...
  grunt.initConfig({
    ...
    sass: {
      docs: {
        ...
        files: {
          '<%= app.docs.dest %>/styles/docs.theme.min.css':
            '<%= app.docs.src %>/scss/docs.theme.scss',
        },
      },
      dist: {
        options: {
        ...
        files: {
          ...
          'dist/owl.theme.default.css': 'src/scss/owl.theme.default.scss',
          'dist/owl.theme.green.css': 'src/scss/owl.theme.green.scss',
        },
      },
    },
    ...
    autoprefixer: {
      ...
      dist: {
        files: {
          ...
          'dist/owl.theme.default.css': 'dist/owl.theme.default.css',
          'dist/owl.theme.green.css': 'dist/owl.theme.green.css',
        },
      },
    },
    ...
    cssmin: {
      dist: {
        files: {
          ...
          'dist/owl.theme.default.min.css': 'dist/owl.theme.default.css',
          'dist/owl.theme.green.min.css': 'dist/owl.theme.green.css',
        },
      },
    },
    ...
    copy: {
      ...
      distToDocs: {
        ...
        cwd: 'dist/',
        src: ['**/*.*'],
        dest: '<%= app.docs.dest %>/owlcarousel',
      },
      ...
      srcToDocs: {
        ...
        cwd: 'src/js',
        src: ['**/*.js'],
        dest: '<%= app.docs.dest %>/owlcarousel/src',
      },
