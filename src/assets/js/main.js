console.log('%c Gaming is a profession.', 'background: #222; color: #bada55');
  ...
  $(document).ready(function () {
    ...
    function init() {
      ...
      var marker = new google.maps.Marker({
        ...
        infoWindow: {
          content:
            '<p><strong>Gamer Ammo, Inc.</strong><br/>9 Groveland St, Battle Creek, MI 49067 <br/>P: (269)389-0082 <br/>United States</p>',
        },
        map: map,
      });
    }
