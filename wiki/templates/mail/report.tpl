{* $Id: report.tpl 58620 2016-05-18 13:09:06Z jonnybradley $ *}{tr _0=$report_site _1=$report_user}Report on %0 for %1{/tr}.{if $report_preferences.type eq 'html'}<br><br>{/if}
